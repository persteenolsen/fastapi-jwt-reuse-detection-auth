...
app = FastAPI(
    ...
    description="08-07-2026 - FastAPI serving Authentication by JWT with Refresh Token Rotation and Revoked Token Reuse Detection using these credentials: testuser / admin",
    version="0.0.2",
